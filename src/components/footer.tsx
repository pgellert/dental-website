...
export default function Footer(props) {
  ...
  <div className="mx-6 py-10 text-center md:text-left border-t border-gray-300">
  ...
  <div className="text-center p-6">
    ...
    <a className="text-gray-600 font-semibold" href="/"> Perinvest Ker. & Szolg Kft</a>
  </div>
</footer>
      </Container>
    </>
...
function UsefulLink({href, title, last=false}) {
  return (
    <p className={last ? "" : "mb-4"}>
      <Link href={href}><a className="text-gray-600">{title}</a></Link>
    </p>
  );
