  ...
  return (
    <div>
      <Head>
        ...
        <meta property="og:url" content={urlForLocale(asPath, locale)} />
        <meta
          property="og:image"
          content="https://www.fogaszatgyor.hu/img/fogorvos-gyor-16x9.jpg"
        />
...
function urlForLocale(asPath, loc) {
...
const structured_data = {
  ...
  description:
    "Győri fogorvosi rendelő, amelynek specialitása a fogászati implantáció, fogpótlás.",
