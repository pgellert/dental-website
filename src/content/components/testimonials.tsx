...
export const data = {
  en: {
    testimonials: [
      {
        text: "Friendly welcome, correct orientation, quality work! Thanks!",
        name: "János",
      },
      {
      ...
      {
        text: "I was here for tooth extraction, completely painlessly and quickly resolved the matter.",
        name: "Csaba",
      },
      {
  ...
  hu: {
    testimonials: [
      {
        text: "Barátságos fogadtatás, korrekt tájákoztatás, minőségi munka! Köszönöm!",
        name: "János",
        date: "2022-03-11",
      },
      {
      ...
      {
        text: "Itt voltam foghúzáson, teljesen fájdalommentesen és gyorsan megoldódott a dolog.",
        name: "Csaba",
        date: "2021-11-07",
      },
      {
  ...
  de: {
    testimonials: [
      ...
      {
        text: "Ich war zur Zahnextraktion hier, völlig schmerzfrei und schnell gelöst.",
        name: "Csaba",
      },
      {
